<template>
  <div class="app">
    ...
    />
    <q-btn class="submit" label="Зарегистрироваться" flat rounded @click="handleSubmit" />
    <q-btn class="other-btn" label="Войти" flat rounded no-caps @click="handleRedirect" />
  </div>
</template>
